...
public class UserIO{
    ...
    // Constructor for UserIO that takes in String type category, 
    // type and quantity
    ...
    public void setCategory(String furnitureCategory)
    {
        if(!(furnitureCategory.equals("chair")) && 
                !(furnitureCategory.equals("desk")) 
                && !(furnitureCategory.equals("lamp")) 
                && !(furnitureCategory.equals("filing")))
        {
            throw new IllegalArgumentException
            ("The category entered is invalid and does not exist in the database.");
        }
    ...
    public void setType(String furnitureType)
    {
        ...
        {
            if(!(furnitureType.equals("Kneeling")) && 
                !(furnitureType.equals("Task")) && 
                !(furnitureType.equals("Mesh")) && 
                !(furnitureType.equals("Executive")) && 
                !(furnitureType.equals("Ergonomic"))){
                    throw new IllegalArgumentException
                    ("The type entered is invalid and does not exist in the table chair.");
               }
        }

        if(this.category.equals("desk"))
        {
            if(!(furnitureType.equals("Standing")) && 
                !(furnitureType.equals("Adjustable")) && 
                !(furnitureType.equals("Traditional")))
            {
                throw new IllegalArgumentException
                ("The type entered is invalid and does not exist in the table desk.");
            }
        }

        if(this.category.equals("lamp"))
        {
            if(!(furnitureType.equals("Desk")) && 
                !(furnitureType.equals("Study")) && 
                !(furnitureType.equals("Swing Arm")))
            {
                throw new IllegalArgumentException
                ("The type entered is invalid and does not exist in the table lamp.");
            }
        }

        if(this.category.equals("filing"))
        {
            if(!(furnitureType.equals("Small")) && 
                !(furnitureType.equals("Medium")) && 
                    !(furnitureType.equals("Large")))
            {
                throw new IllegalArgumentException
                ("The type entered is invalid and does not exist in the table filing.");
            }
        }
        this.type = furnitureType;
    }

    // Setter method for quantity, it throws IllegalArgumentException 
    // if the quantity provided is not an integer.
    public void setQuantity(String number)
    {
        ...
        {
            throw new IllegalArgumentException
                ("The number of items entered is not an integer.");
        }
    ...
    */
    public void userInput()
    {
        ...
        System.out.println("(must be all lowercase):");
        setCategory(input.nextLine());

        System.out.print("Enter furniture type ");
        System.out.println("(first letter of each word must be uppercase): ");
